...
const CreatePin = ({ user }) => {
  ...
  const uploadImage = (e) => {
    ...
    if(type === 'image/png' || type === 'image/svg' || type === 'image/jpeg' || type === 'image/gif' || type === 'image/tiff'){
      ...
      .catch((error) => {
        console.log('Image uploaad error ', error)
      })
    } else {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3mlg:w-4/5 w-full">
          ...
          <div className="flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
            ...
            {!imageAsset ? (
              <label>
                <div className="flex flex-col jusify-center items-center h-full">
                  ...
                  <p className="mt-32 text-gray-400">
                     Use high quality JPG, SVG, PNG, GIF less than 20 MG
                  </p>
                </div>
                <input 
                  type="file"
              ...
              <div className="relative h-full">
                ...
                <button 
                type="button"
                className="absolute bottom-3 right-3 p-3 rounded-full bg-white text-xl cursor-pointer outline-none hover:shawdow:md transition-all duration-500 ease-in-out"
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-end items-end mt-5">
                ...
                type="button"
                onClick={savePin}
                className="bg-purple-800 text-white font-bold p-2 rounded-full w-28 outline-none"
                >
                  Save Pin
                </button>
            </div>
